...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        if (contactConfig && contactConfig.badWords) {
            const hasBadWord = contactConfig.badWords.some(word => 
                message.toLowerCase().includes(word.toLowerCase())
            );
            
            if (hasBadWord) {
                formStatus.textContent = "الرسالة تحتوي على كلمات غير لائقة. يرجى تعديلها.";
